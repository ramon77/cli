...
BASE = '../bot/'
SUDO = 475975207 --sudo id
sudo_users = {475975207,513972374,527789307,userid}
...
-- mods
   ...
   -- member
   if text == 'ping' then
          local a = {"<code>ربات تلگرام گارد فعال و آماده کار است.</code>","<code>ربات تلگرام گارد فعال است</code>","<b>pong!</b>"}
